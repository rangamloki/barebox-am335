...
static const struct am33xx_cmd_control phycore_am335_cmd = {
	.slave_ratio0 = 0x40,
	.dll_lock_diff0 = 0x0,
	.invert_clkout0 = 0x1,
	.slave_ratio1 = 0x40,
 ...
 * @return void
 */
static int phycore_am335_board_init(void)
{
	...
	if (IS_ENABLED(CONFIG_512MB_MT41J128M16_1x512M16))
		am335x_sdram_init(0x18B, &phycore_am335_cmd,
